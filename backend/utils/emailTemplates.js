    ...
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px;">
                ...
                <p style="color: #555;">Someone has sent you a message on Chocowi. Click the button below to view and respond.</p>
    ...
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px;">
                ...
                <p style="color: #555;">Admin has sent you a message on Chocowi. Click the button below to view and respond.</p>
                <a href="${messageLink}" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">Open Chat</a>
            </div>
        </div>
    `;
    ...
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px;">
                ...
                <p style="color: #555;">A seller has sent you an offer on Chocowi. Click the button below to view and respond.</p>
    ...
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px;">
                ...
                <p>Thank you for choosing Chocowi!</p>
                <p>Best regards,<br/>The Chocowi Team</p>
    ...
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px;">
                ...
                <p>Thank you for being a valued member of the Chocowi community!</p>
                <p>Best regards,<br/>The Chocowi Team</p>
            </div>
        </div>
    `;
    ...
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px;">
                ...
                <p>We hope you continue to have success selling on Chocowi, and we’re here to assist you if you have any concerns.</p>
                <p>Best regards,<br/>The Chocowi Team</p>
                <a href="https://faithzy.com/orders" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px;">View Orders</a>
            </div>
        </div>
...
exports.welcomeEmail = (userName) => {
    return `
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 8px;">
                <h2 style="color: #333;">Welcome to Chocowi, ${userName}!</h2>
                <p style="color: #555;">We're excited to have you join our community where you can explore and sell religious products and services. Whether you're here to buy or sell, Chocowi offers a platform dedicated to faith-inspired commerce.</p>
                ...
                <p style="color: #555;">Thank you for being a part of Chocowi, and we look forward to seeing you thrive!</p>
                <p style="color: #555;">Best regards,<br/>The Chocowi Team</p>
            </div>
        </div>
    `;
};
